    ...
    return (
        <>
          ...
          <li><Link to="/signin" className="hover:text-purple-600 hover:scale-110 transition-all duration-300">Sign in</Link></li> */}
                    <li className="hover:text-purple-600 hover:scale-110 transition-all duration-300">
                        <Logout id_admin={1} />
                    </li>
                </ul>
            </nav>
            ...
            >
                ...
                <div className="flex flex-col items-center mt-10 gap-7 ">
                    ...
                    <Link
                        to="/"
                        onClick={toggleMenu}
                        className="text-lg font-bold text-blue-900 hover:text-purple-600 hover:scale-110 transition-all duration-300"
                    >
                        Accueil
                    </Link>
                    <Link
          ...
          <Link to="/signin" onClick={toggleMenu} className="text-lg font-bold text-blue-900">Sign in</Link> */}
                    <div className="text-lg font-bold text-blue-900 hover:text-purple-600 hover:scale-110 transition-all duration-300">
                        <Logout />
                    </div>
                </div>
            </div>
